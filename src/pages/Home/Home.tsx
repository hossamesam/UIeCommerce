  ...
  return (
    <div>
      ...
      <div className='max-xl:hidden flex gap-4 w-full justify-center'>
        <img className='rounded-3xl w-[381px] h-[480px] ' src={"https://ik.imagekit.io/Hossam7w3cncwb9/assets/image%20101.png?updatedAt=1752005273886"} alt="img1" />
        <img className='rounded-3xl w-[381px] h-[480px] ' src={"https://ik.imagekit.io/Hossam7w3cncwb9/assets/image%20100.png?updatedAt=1752005266926"} alt="img2" />
        <img className='rounded-3xl w-[381px] h-[480px] ' src={"https://ik.imagekit.io/Hossam7w3cncwb9/assets/image%20106.png?updatedAt=1752005266814"} alt="img3" />
      </div>
      <div className='min-xl:hidden flex gap-4  w-full justify-center'>
        <img className='rounded-3xl w-[190.5px]  h-[240px]' src={"https://ik.imagekit.io/Hossam7w3cncwb9/assets/image%20101.png?updatedAt=1752005273886"} alt="img1" />
        <img className='rounded-3xl w-[190.5px] h-[240px]' src={"https://ik.imagekit.io/Hossam7w3cncwb9/assets/image%20100.png?updatedAt=1752005266926"} alt="img2" />
        <img className='rounded-3xl w-[190.5px] h-[240px]' src={"https://ik.imagekit.io/Hossam7w3cncwb9/assets/image%20106.png?updatedAt=1752005266814"} alt="img3" />
      </div>
      ...
      <img className='min-xl:h-[721px] w-full' src={"https://ik.imagekit.io/Hossam7w3cncwb9/assets/shop/Images.png?updatedAt=1752005340121"} />
    </div>
  )
}
export default Home
...
export function Carousel() {
  const slideImages = [
    { img: "https://ik.imagekit.io/Hossam7w3cncwb9/assets/slider/Rectangle%2026.png?updatedAt=1752005318260" },
    { img: "https://ik.imagekit.io/Hossam7w3cncwb9/assets/slider/Rectangle%2025.png?updatedAt=1752005315450" },
    { img: "https://ik.imagekit.io/Hossam7w3cncwb9/assets/slider/Rectangle%2024.png?updatedAt=1752005315385" },
  ];
